...
export function ConversationTabs({
  ...
  return (
    <div className="relative w-full flex-shrink-0 py-0.5">
      <div className="relative overflow-hidden rounded-b-[22px] rounded-t-none border-x-0 border-b-[1.5px] border-t-0 border-slate-300/95 bg-white/84 shadow-[0_14px_30px_-20px_rgba(15,23,42,0.16),0_16px_36px_-28px_rgba(76,29,149,0.3)] backdrop-blur-xl dark:border-slate-600/90 dark:bg-slate-950/68 dark:shadow-[0_16px_34px_-24px_rgba(0,0,0,0.6),0_18px_36px_-30px_rgba(76,29,149,0.28)]">
        <div
        ...
        <div className="relative flex min-h-0 items-center">
          ...
          <div className="flex shrink-0 items-center border-l border-slate-200/90 bg-gradient-to-b from-white/90 to-indigo-50/40 py-1.5 pl-2.5 pr-3 backdrop-blur-sm dark:border-slate-600/80 dark:from-slate-950/90 dark:to-indigo-950/35">
            <button
              type="button"
              title="新建对话"
              aria-label="新建对话"
